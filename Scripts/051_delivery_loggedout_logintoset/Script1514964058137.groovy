...
WebUI.click(findTestObject('SetDeliveryInfo/div_login to set delivery'))
...
WebUI.verifyElementPresent(findTestObject('SetDeliveryInfo/h1_select delivery add box'), 0)

WebUI.verifyElementText(findTestObject('SetDeliveryInfo/span_I want my food'), 'I want my food delivered')
