...
WebUI.setText(findTestObject('Account/input_renewpassword'), GlobalVariable.password_placeholder + 'mismatch')

WebUI.click(findTestObject('Account/button_Save password'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Account/div_passwords error'), 'passwords_do_not_match')
...
WebUI.setText(findTestObject('LogIn/input_password-XPATH'), GlobalVariable.password_placeholder)
