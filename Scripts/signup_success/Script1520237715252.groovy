...
'logout and re-login with new acount'
WebUI.waitForElementVisible(findTestObject('LogIn/div_Hi user-XPATH'), 0)

WebUI.click(findTestObject('LogIn/div_Hi user-XPATH'))

WebUI.waitForElementVisible(findTestObject('LogIn/a_Sign out'), 0)

WebUI.waitForElementClickable(findTestObject('LogIn/a_Sign out'), 0)

WebUI.click(findTestObject('LogIn/a_Sign out'))

WebUI.waitForElementVisible(findTestObject('Account/button_Sign Out'), 0)
...
WebUI.waitForElementVisible(findTestObject('LogIn/input_email-XPATH'), 0)

WebUI.setText(findTestObject('LogIn/input_email-XPATH'), ((str1 + '@') + str2) + '.com')
