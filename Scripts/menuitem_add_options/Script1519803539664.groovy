...
WebUI.waitForElementVisible(findTestObject('AddItems/button_Add 3-XPATH'), 0)

WebUI.click(findTestObject('AddItems/button_Add 3-XPATH'), FailureHandling.STOP_ON_FAILURE)
