...
WebUI.setText(findTestObject('SetDeliveryInfo/input_deliveryAddressPostal'), GlobalVariable.postalcode_out)
...
WebUI.verifyElementText(findTestObject('SetDeliveryInfo/span_error_general-XPATH'), 'Sorry your address is outside our delivery area.')
