...
WebUI.setText(findTestObject('SignUp/input_phone'), 'phone_number')
...
WebUI.verifyElementVisible(findTestObject('SignUp/span_Please enter your phone n'), FailureHandling.STOP_ON_FAILURE)
