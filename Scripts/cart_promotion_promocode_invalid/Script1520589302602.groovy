...
'ensure promocode is not available'
WebUiBuiltInKeywords.setText(findTestObject('Promotions/input_Promo Code-XPATH'), 'invalidpromocode123')
...
WebUiBuiltInKeywords.verifyElementNotPresent(findTestObject('Promotions/div_Promo Code Success-XPATH'), 0)
