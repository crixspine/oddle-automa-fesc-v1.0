...
WebUI.setText(findTestObject('Account/input_deliveryAddressPostal'), '111111')
...
WebUI.setText(findTestObject('Account/input_deliveryAddressOne'), GlobalVariable.address)
...
WebUI.verifyElementText(findTestObject('Account/span_new address postcode'), '111111')
