...
WebUI.setText(findTestObject('Account/input_lastname'), '@wronglname')

WebUI.click(findTestObject('Account/button_Save'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Account/div_error_message'), 'last_name_invalid')
...
newLname = WebUI.getAttribute(findTestObject('Account/input_lastname'), 'value')

WebUI.verifyNotMatch('@wronglname', newLname, false)
