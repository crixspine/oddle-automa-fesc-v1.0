...
WebUI.setText(findTestObject('SignUp/input_lastName'), 'lastname123')
...
WebUI.verifyElementVisible(findTestObject('SignUp/span_Please enter your last na'), FailureHandling.STOP_ON_FAILURE)
