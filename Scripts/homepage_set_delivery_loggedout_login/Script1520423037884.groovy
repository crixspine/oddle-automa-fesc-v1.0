...
WebUiBuiltInKeywords.waitForElementVisible(findTestObject('SetDeliveryInfo/div_login to set delivery-XPATH'), 0)

WebUI.click(findTestObject('SetDeliveryInfo/div_login to set delivery-XPATH'))
...
WebUI.verifyElementPresent(findTestObject('SetDeliveryInfo/span_I want my food delivered'), 0)
