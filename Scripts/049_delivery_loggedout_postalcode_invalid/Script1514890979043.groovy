...
WebUI.setText(findTestObject('SetDeliveryInfo/input_deliveryAddressPostal'), '111111')
...
WebUI.verifyElementText(findTestObject('SetDeliveryInfo/span_error_general'), 'error_general')
