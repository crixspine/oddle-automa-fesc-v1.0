...
WebUI.setText(findTestObject('Account/input_phone'), '123456')

WebUI.click(findTestObject('Account/button_Save'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Account/div_error_message'), 'phone_invalid')
...
newPhone = WebUI.getAttribute(findTestObject('Account/input_phone'), 'value')

WebUI.verifyNotMatch('123456', newPhone, false)
