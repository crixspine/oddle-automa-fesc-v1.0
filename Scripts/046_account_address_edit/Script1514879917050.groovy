...
WebUI.click(findTestObject('Account/button_edit address'))
...
WebUI.verifyElementPresent(findTestObject('Account/span_address 1 postcode'), 0)

WebUI.verifyElementPresent(findTestObject('Account/h4_address 1'), 0)

WebUI.verifyElementText(findTestObject('Account/span_address 1 postcode'), 'Singapore ' + GlobalVariable.postalcode)
