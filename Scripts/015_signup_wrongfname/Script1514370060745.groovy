...
WebUI.setText(findTestObject('SignUp/input_firstName'), 'invalidfirstname0')
...
WebUI.verifyElementText(findTestObject('SignUp/span_Please enter your first n'), 'Please enter your first name')
