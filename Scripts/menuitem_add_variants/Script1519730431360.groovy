...
WebUI.waitForElementVisible(findTestObject('AddItems/button_Add 2-XPATH'), 0)

WebUI.click(findTestObject('AddItems/button_Add 2-XPATH'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('AddItems/span_Var2-XPATH'), 0)

WebUI.waitForElementVisible(findTestObject('AddItems/span_Var2-XPATH'), 0)

WebUI.click(findTestObject('AddItems/span_Var2-XPATH'), FailureHandling.STOP_ON_FAILURE)
