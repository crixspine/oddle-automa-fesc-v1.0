...
WebUI.setText(findTestObject('SignUp/input_firstName'), 'first_name')
...
WebUI.verifyElementVisible(findTestObject('SignUp/span_Please enter your first n'), FailureHandling.STOP_ON_FAILURE)
