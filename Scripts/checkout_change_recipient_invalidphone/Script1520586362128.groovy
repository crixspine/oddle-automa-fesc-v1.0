...
WebUI.setText(findTestObject('Checkout/input_recipient name'), 'recipient name')

WebUI.setText(findTestObject('Checkout/input_recipient phone'), 'invalid_phone_123')
...
WebUI.verifyElementPresent(findTestObject('Checkout/span_Please enter valid recipient number'), 0)
