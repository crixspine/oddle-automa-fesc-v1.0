...
WebUI.setText(findTestObject('LogIn/input_email-XPATH'), GlobalVariable.email_placeholder)
...
WebUI.verifyElementPresent(findTestObject('LogIn/div_login_credentials_invalid-XPATH'), 0)

WebUI.waitForElementVisible(findTestObject('LogIn/svg_close window-XPATH'), 0)
