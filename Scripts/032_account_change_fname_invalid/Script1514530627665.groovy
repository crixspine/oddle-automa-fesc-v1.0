...
WebUI.setText(findTestObject('Account/input_firstname'), 'wrongfname1')

WebUI.click(findTestObject('Account/button_Save'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Account/div_error_message'), 'first_name_invalid')
...
newFname = WebUI.getAttribute(findTestObject('Account/input_firstname'), 'value')

WebUI.verifyNotMatch('wrongfname1', newFname, false)
