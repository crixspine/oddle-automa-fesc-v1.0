...
WebUI.setText(findTestObject('Account/input_email'), GlobalVariable.email_regd)

WebUI.click(findTestObject('Account/button_Save'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Account/div_error_message'), 'customer_email_duplicate')
...
WebUI.verifyNotMatch(GlobalVariable.email_regd, newEmail, false)
